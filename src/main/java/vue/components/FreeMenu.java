...
public class FreeMenu extends VBox {

    public FreeMenu() {
        super();

        // Couche 1 : Region avec le background
        Image backgroundImage = new Image(getClass().getResourceAsStream("/vue/img/free-background.png"));
        ...
        Text title = new Text("Mode Libre");
        title.getStyleClass().add("title");

        Text subtitle = new Text("Entrainez vous à l’infini dans le mode libre !");
